...
export const exchangeMapping = new Map<string, string>()
exchangeMapping.set(FACTORY_ADDRESS.toHexString(), "Sushiswap")
exchangeMapping.set(UNISWAP_FACTORY_ADDRESS.toHexString(), "Uniswap")
